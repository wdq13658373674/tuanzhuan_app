  ...
  <div class="reg-wrap">
    ...
    <form action="">
      <div class="input-group no-border">
        <div class="area-num">
          <span class="add">+</span>
          <input class="input w100" type="text" v-model="area" autocomplete="off" readonly="readonly">
        </div>
        <div class="input-box">
          <input class="input" type="text" name="phone" v-model="phone" autocomplete="off" placeholder="手机号码">
        </div>
      </div>
  ...
  export default {
    ...
    methods:{
      ...
      next:function () {
        ...
        this.$router.push({ name: 'Password', params: { phone: this.phone,code:this.code }});
      },
    }
  }
</script>
